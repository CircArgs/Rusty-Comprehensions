...
mod tests {
    ...
    fn test_nesting() {
        assert_eq!(
            comp_pre![comp_pre![y2+z2; for _x2 in 1..x, let y2=x*x+4, let z2 = 3*y+x, if z2>20]; for x in 1..4, let y=x*x+4, if x>1],
    ...
    fn test_complicated() {
        assert_eq!(
            comp_pre![y+zz*z; for x in 1..4, let y=x*x+4, let z = 3*y+x, if z>20; for yy in 1..10, let zz= yy+1; for _yyy in 1..10, if yy>7; for _i in 1..3],
            vec![
